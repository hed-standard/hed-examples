%% This script shows the steps involved in merging the EEG.set files.
% The example uses the Attention Shift dataset. The first file already
% has a pause event with code 202 located at the last sample in the file.
